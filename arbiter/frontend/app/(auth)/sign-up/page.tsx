  ...
  return (
    <div className="rounded-2xl border border-[#1a1a1a] bg-[#050505] p-8">
      ...
      <p className="text-center text-[#333] text-xs mt-5 leading-relaxed">
        ...
        <a href="/terms" className="text-[#555] hover:text-white underline underline-offset-2">Terms</a>
        {' '}and{' '}
        <a href="/privacy" className="text-[#555] hover:text-white underline underline-offset-2">Privacy Policy</a>.
      </p>

      <p className="text-center text-[#444] text-xs mt-4">
        Already have an account?{' '}
        <Link href="/sign-in" className="text-white hover:text-[#aaa] transition-colors underline underline-offset-2">
          Sign in
        </Link>
      </p>
    </div>
